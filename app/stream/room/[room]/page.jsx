    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 1 }}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                        ...
                        <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                            ...
                            />
                            <Typography sx={{ color: "#fff" }}>{isStreaming ? "LIVE" : "OFF"}</Typography>
                            <VisibilityIcon fontSize="small" sx={{ color: "#fff" }} />
                            <Typography sx={{ color: "#fff" }}>{viewerCount}</Typography>
                        </Box>
                    </Box>
                ...
                {showQuestions && (
                    ...
                    >
                        ...
                        <Button variant="contained" sx={{ bgcolor: "#6f5bd4" }} onClick={nextQuestion}>
                            Next
                        </Button>
                    </Box>
                )}
            ...
            >
                ...
                {/* ⭐ CHAT MESSAGE LIST — fills all space */}
                <Paper
                    sx={{
                        flex: 1,                    // ⭐ fills entire available height
                        overflowY: "auto",
                        p: 2,
                        bgcolor: "#1e1628",
                        mb: 2,                      // small gap above input row
                        borderRadius: 2
                    }}
                >
                    {chat.map((m, i) => (
                        ...
                        >
                            ...
                            <Typography sx={{ fontSize: 14, color: "#ddd", lineHeight: 1.4 }}>
                                {m.text}
                            </Typography>
                        </Box>
                    ))}
                ...
                {/* ⭐ INPUT BAR ALWAYS STAYS AT BOTTOM */}
